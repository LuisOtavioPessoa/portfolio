export const pt = {
    ...
    inicio: {
        ...
        titulo: "Transformo ideias em experiências digitais inovadoras, unindo design intuitivo, interfaces modernas e código de alta performance.",
    ...
    sobre: {
        ...
        formacao: {
            ...
            texto1: 
                "Formação completa em Análise e Desenvolvimento de Sistemas, com foco em desenvolvimento de software, aplicações web e mobile. A graduação abrangeu fundamentos sólidos em Redes de Computadores, Arquitetura de Computadores e Banco de Dados, além de práticas voltadas ao planejamento, modelagem e implementação de sistemas."         
        },
    },
    projetos: {
        tituloSecao: "Projetos",
        tecnologia: "Tecnologias",
        tecnologia2: "Tecnologias Utilizadas",
        lista: [
            {
