export const en = {
  ...
  inicio: {
        ...
        titulo: "I turn ideas into innovative digital experiences, combining intuitive design, modern interfaces, and high-performance code.",
  ...
  sobre: {
      ...
      formacao: {
          titulo: "Education",
          subtitulo: "Systems Analysis and Development",
          subtitulo2: "Centro Universitário de João Pessoa - UNIPÊ",
          tempoExperiencia: "2023 - 2025",
          texto1:
              "Bachelor’s degree in Systems Analysis and Development, with a strong focus on software engineering, web, and mobile application development. The program provided a solid foundation in Computer Networks, Computer Architecture, and Databases, along with practical experience in system planning, modeling, and implementation.",
      }
    },
    projetos: {
        tituloSecao: "Projects",
        tecnologia: "Technologies",
        tecnologia2: "Technologies Used",
        lista: [
            {
                titulo: "F360 Platform",
                descricao: [
                    "Web application developed to structure and modernize the management of Unipê's Software Factory.",
                    "The solution offers complete administrative control over students, projects, workshops, lectures, and immersions, replacing manual and decentralized processes."
                ]
            },
            {
